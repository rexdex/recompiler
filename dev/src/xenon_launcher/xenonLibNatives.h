...
#define X_HRESULT_FROM_WIN32(x) ((X_RESULT)(x) <= 0 ? ((X_RESULT)(x)) : ((X_RESULT) (((x) & 0x0000FFFF) | (X_FACILITY_WIN32 << 16) | 0x80000000)))
		enum XResult
		{
			...
			X_ERROR_FILE_NOT_FOUND = X_HRESULT_FROM_WIN32(0x00000002L),
			X_ERROR_PATH_NOT_FOUND = X_HRESULT_FROM_WIN32(0x00000003L),
			X_ERROR_ACCESS_DENIED = X_HRESULT_FROM_WIN32(0x00000005L),
			X_ERROR_INVALID_HANDLE = X_HRESULT_FROM_WIN32(0x00000006L),
			X_ERROR_NO_MORE_FILES = X_HRESULT_FROM_WIN32(0x00000012L),
			X_ERROR_INVALID_PARAMETER = X_HRESULT_FROM_WIN32(0x00000057L),
			X_ERROR_IO_PENDING = X_HRESULT_FROM_WIN32(0x000003E5L),
			X_ERROR_INSUFFICIENT_BUFFER = X_HRESULT_FROM_WIN32(0x0000007AL),
			X_ERROR_INVALID_NAME = X_HRESULT_FROM_WIN32(0x0000007BL),
			X_ERROR_BAD_ARGUMENTS = X_HRESULT_FROM_WIN32(0x000000A0L),
			X_ERROR_BUSY = X_HRESULT_FROM_WIN32(0x000000AAL),
			X_ERROR_ALREADY_EXISTS = X_HRESULT_FROM_WIN32(0x000000B7L),
			...
			X_ERROR_NOT_LOGGED_ON = X_HRESULT_FROM_WIN32(0x000004DDL),
			X_ERROR_NO_SUCH_USER = X_HRESULT_FROM_WIN32(0x00000525L),
			X_ERROR_FUNCTION_FAILED = X_HRESULT_FROM_WIN32(0x0000065BL),
