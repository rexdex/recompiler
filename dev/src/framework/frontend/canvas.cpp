...
BEGIN_EVENT_TABLE( Canvas::CCanvasPanel, wxWindow )
	EVT_PAINT( CCanvasPanel::OnPaint )
	EVT_ERASE_BACKGROUND( CCanvasPanel::OnEraseBackground )
	EVT_MOTION( CCanvasPanel::OnMouseMove )
	EVT_LEFT_DOWN( CCanvasPanel::OnMouseEvent )
	EVT_LEFT_DCLICK( CCanvasPanel::OnMouseEvent )
	EVT_LEFT_UP( CCanvasPanel::OnMouseEvent )
	EVT_RIGHT_DOWN( CCanvasPanel::OnMouseEvent )
	EVT_RIGHT_DCLICK( CCanvasPanel::OnMouseEvent )
	EVT_RIGHT_UP( CCanvasPanel::OnMouseEvent )
	EVT_SIZE( CCanvasPanel::OnSize )
END_EVENT_TABLE()

namespace Canvas
{
CCanvasPanel::CCanvasPanel( wxWindow* parent, long style )
...
void CCanvasPanel::Repaint()
{
	Refresh( false );
}

void CCanvasPanel::CaptureMouse( EMouseCaptureMode mode )
{
...
void CCanvasPanel::SetScale( float scale )
{
	// New scale ?
	if ( scale != m_scale )
	{
...
void CCanvasPanel::SetOffset( const float x, const float y)
{
	// New offset ?
...
void CCanvasPanel::Scroll( const float dx, const float dy, const bool respectScale )
{
	if (dx || dy)
	{
...
wxPoint CCanvasPanel::CanvasToClient( wxPoint point ) const
{
...
/*FVector2 CCanvasPanel::CanvasToClient( FVector2 point ) const
{
...
wxPoint CCanvasPanel::ClientToCanvas( wxPoint point ) const
{
...
/*FVector2 CCanvasPanel::ClientToCanvas( FVector2 point ) const
{
...
wxRect CCanvasPanel::CanvasToClient( wxRect rect ) const
{
	// Transform corners
...
wxRect CCanvasPanel::ClientToCanvas( wxRect rect ) const
{
	// Transform corners
...
wxPoint CCanvasPanel::CalcTextExtents( EFontType font, const char* text )
{	
...
wxRect CCanvasPanel::CalcTextRect( EFontType font, const char* text )
{
	wxPoint size = CalcTextExtents( font, text );
	return wxRect( 0, 0, size.x, size.y );
}

void CCanvasPanel::SetClip( const wxRect &rect )
{
	if ( m_bufferDevice )
	{
...
void CCanvasPanel::Clear( const wxColour& color )
{
	if ( m_bufferDevice )
	{
...
void CCanvasPanel::DrawText( const wxPoint& offset, EFontType font, const char* text, const wxColour &color )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Font* drawFont = SelectFont( font );
...
void CCanvasPanel::DrawText( const wxPoint& offset, EFontType font, const char* text, const wxColour &color, EVerticalAlign vAlign, EHorizontalAlign hAlign )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Font* drawFont = SelectFont( font );
...
void CCanvasPanel::DrawText( const wxPoint& topLeft, uint32 width, uint32 height, EFontType font, const char* text, const wxColour &color )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Font* drawFont = SelectFont( font );
...
void CCanvasPanel::DrawRect( const wxRect& rect, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
...
void CCanvasPanel::DrawRect( int x, int y, int w, int h, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::FillRect( const wxRect& rect, const wxColour& color )
{
	if ( m_bufferDevice )
	{
...
void CCanvasPanel::FillRect( int x, int y, int w, int h, const wxColour& color )
{
	if ( m_bufferDevice )
	{
		Gdiplus::SolidBrush drawBrush( ToColor( color ) );
...
void CCanvasPanel::FillGradientHorizontalRect( const wxRect& rect, const wxColour& leftColor, const wxColour& rightColor )
{
	if ( m_bufferDevice )
	{
...
void CCanvasPanel::FillGradientVerticalRect( const wxRect& rect, const wxColour& upColor, const wxColour& downColor )
{
	if ( m_bufferDevice )
	{
...
void CCanvasPanel::DrawLine( int x1, int y1, int x2, int y2, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::DrawLine( const wxPoint& start, const wxPoint &end, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::DrawLines( const wxPoint* points, const int numPoints, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::DrawArc( const wxRect &rect, float startAngle, float sweepAngle, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::DrawCircle( int x, int y, int radius, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::DrawCircle( const wxPoint &center, int radius, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::FillCircle( int x, int y, int radius, const wxColour& color )
{
	if ( m_bufferDevice )
	{
		Gdiplus::SolidBrush drawBrush( ToColor( color ) );
...
void CCanvasPanel::FillCircle( const wxPoint &center, int radius, const wxColour& color )
{
	if ( m_bufferDevice )
	{
		Gdiplus::SolidBrush drawBrush( ToColor( color ) );
...
void CCanvasPanel::DrawCircle( int x, int y, int w, int h, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::DrawCircle( const wxRect& rect, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
void CCanvasPanel::FillCircle( int x, int y, int w, int h, const wxColour& color )
{
	if ( m_bufferDevice )
	{
		Gdiplus::SolidBrush drawBrush( ToColor( color ) );
...
void CCanvasPanel::FillCircle( const wxRect& rect, const wxColour& color )
{
	if ( m_bufferDevice )
	{
		Gdiplus::SolidBrush drawBrush( ToColor( color ) );
...
void CCanvasPanel::DrawCurve( const wxPoint *points, const wxColour& color, float width /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		Gdiplus::Pen drawPen( ToColor( color ), width );
...
bool CCanvasPanel::HitTestCurve( const wxPoint *points, const wxPoint& point, const float range /*=1.0f*/ )
{
...
void CCanvasPanel::DrawRoundedRect( const wxRect& rect, const wxColour& color, int radius, float borderWidth /*=1.0f*/ )
{
	DrawRoundedRect( rect.x, rect.y, rect.width, rect.height, color, radius, borderWidth );
}

void CCanvasPanel::DrawRoundedRect( int x, int y, int width, int height, const wxColour& color, int radius, float borderWidth /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::FillRoundedRect( const wxRect& rect, const wxColour& color, int radius )
{
	FillRoundedRect( rect.x, rect.y, rect.width, rect.height, color, radius );
}

void CCanvasPanel::FillRoundedRect( int x, int y, int width, int height, const wxColour& color, int radius )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::DrawCuttedRect( const wxRect& rect, const wxColour& color, int radius, float borderWidth /*=1.0f*/ )
{
	DrawCuttedRect( rect.x, rect.y, rect.width, rect.height, color, radius, borderWidth );
}

void CCanvasPanel::DrawCuttedRect( int x, int y, int width, int height, const wxColour& color, int radius, float borderWidth /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::FillCuttedRect( const wxRect& rect, const wxColour& color, int radius )
{
	FillCuttedRect( rect.x, rect.y, rect.width, rect.height, color, radius );
}

void CCanvasPanel::FillCuttedRect( int x, int y, int width, int height, const wxColour& color, int radius )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::DrawDownArrow( const wxRect& rect, const wxColour& backColor, const wxColour& borderColor )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::DrawUpArrow( const wxRect& rect, const wxColour& backColor, const wxColour& borderColor )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::DrawTriangle( int x1, int y1, int x2, int y2, int x3, int y3, const wxColour& color, float borderWidth /*=1.0f*/ )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::FillTriangle( int x1, int y1, int x2, int y2, int x3, int y3, const wxColour& color )
{
	if ( m_bufferDevice )
	{
		// Assemble bounds
...
void CCanvasPanel::DrawTipRect( int x1, int y1, int x2, int y2, const wxColour& borderColor, const wxColour& interiorColor, uint32 size )
{
	{
		wxPoint tip( x1, y1 );
...
void CCanvasPanel::DrawPoly( const wxPoint *points, uint32 numPoints, const wxColour& borderColor, float borderWidth /*=1.0f*/ )
{
...
void CCanvasPanel::FillPoly( const wxPoint *points, uint32 numPoints, const wxColour& color )
{
	if ( m_bufferDevice && numPoints )
	{
		Gdiplus::GraphicsPath gp;
...
void CCanvasPanel::OnPaint( wxPaintEvent& event )
{
...
void CCanvasPanel::OnEraseBackground( wxEraseEvent& event )
{
	// Do not redraw background
}

void CCanvasPanel::OnSize( wxSizeEvent& event )
{
	if ( m_bitmapBuffer )
	{
...
void CCanvasPanel::OnMouseEvent( wxMouseEvent& event )
{
...
void CCanvasPanel::OnMouseMove( wxMouseEvent& event )
{
...
void CCanvasPanel::UpdateTransformMatrix()
{
	if ( m_bufferDevice )
	{
...
void CCanvasPanel::RecreateDevice( uint32 newWidth, uint32 newHeight )
{
...
void CCanvasPanel::ToggleQualityMode( bool hiQuality )
{
	if ( m_bufferDevice )
	{
		if ( hiQuality )
...
Gdiplus::Font* CCanvasPanel::SelectFont( EFontType font )
{
...
void CCanvasPanel::OnPaintCanvas( int width, int height )
{
}

void CCanvasPanel::OnMouseClick( wxMouseEvent& event )
{

}

void CCanvasPanel::OnMouseMove( wxMouseEvent& event, wxPoint delta )
{

}

void CCanvasPanel::OnMouseTrack( wxMouseEvent& event )
{
