...
#include "canvas.h"
#include "../backend/timemachine.h"

//-----------------------------------------------------------------------------

/// Displays code casual history
class CTimeMachineView : public Canvas::CCanvasPanel
{
public:
	CTimeMachineView( wxWindow* parent, class timemachine::Trace* trace );
	virtual ~CTimeMachineView();

	// Set trace data index
	const int32 GetRootTraceIndex() const;
