...
class CListBoxUpdate : public wxEvtHandler
{
private:
...
public:
	CListBoxUpdate( class wxWindow* parent, const char* name, bool allowEmpty = false, bool issueEvent = true );
	~CListBoxUpdate();
...
/// Text window updater
class CTextBoxUpdate : public wxEvtHandler
{
private:
...
public:
	CTextBoxUpdate( wxWindow* parent, const char* name );
	~CTextBoxUpdate();

	// set the text value
	CTextBoxUpdate& SetText( const char* txt, ... );

	// select all of the test
	CTextBoxUpdate& SelectText();
...
public:
	CTextBoxReader( wxWindow* parent, const char* name );
	~CTextBoxReader();
...
class CTextBoxErrorHint : public wxEvtHandler
{
private:
	class wxTextCtrl*	m_textBox;
	bool				m_hasError;
...
public:
	CTextBoxErrorHint( wxWindow* parent, const char* name );
	~CTextBoxErrorHint();
...
class CToggleButtonAuto : public wxEvtHandler
{
private:
...
public:
	CToggleButtonAuto( wxWindow* parent, const char* name, const char* customOnText = nullptr, const char* customOffText = nullptr, const bool defaultValue = false );
	~CToggleButtonAuto();
