...
#include "../../../framework/backend/platformCPU.h"
...
public:
	...
	virtual const bool Decompile(class ILogOutput& output, const uint32 address, const decoding::Instruction& op, const decoding::InstructionExtendedInfo& exInfo, class code::Generator& codeGen, std::string& outCode) const = 0;
